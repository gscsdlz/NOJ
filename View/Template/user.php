...
<div class="row">
	<div class="col-md-2 col-md-offset-2 text-center well"
		...
		?>
		"
			alt="" class="img-rounded" width="80%" id="header">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="Nickname"
										name="newNickname" <?php if($activate == 0) echo 'readonly="readonly"';?> placeholder="Nickname"
...
<?php }?>
			...
			<tr>
				<td>电子邮箱</td>
				<td><?php if(isset($email)) echo '<a href="mailto:'.$email.'">'.$email.'</a>';?></td>
			</tr>
