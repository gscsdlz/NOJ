		...
		<table class="table table-hover">
			<tr>
				...
				<th><button type="button" class="btn btn-danger" data-toggle="modal"
						data-target="#delModal">删除本小组</button></th>
				<th><button type="button" class="btn btn-success" data-toggle="modal"
	...
	$(document).ready(function(){
		...
		$(".list-group li").click(function(){
			...
			$.post("/admin/userM/groupList", {gid:id}, function (data){
				var arr = eval("(" + data + ")");
				$("#grouplist").html('<tr class="text-center"><td colspan="4" id="groupName">小组名</td></tr>');	
